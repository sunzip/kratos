...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/sunzip/kratos/contrib/config/apollo/v2)
...
import (
	...
	"github.com/sunzip/kratos/contrib/config/apollo/v2"
