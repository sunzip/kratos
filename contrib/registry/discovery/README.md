...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/sunzip/kratos/contrib/registry/discovery/v2)
...
```go
import (
	"github.com/sunzip/kratos/contrib/registry/discovery/v2"
)
...
import (
	"github.com/sunzip/kratos/contrib/registry/discovery/v2"
	"github.com/sunzip/kratos/v2/transport/grpc"
)
