...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/sunzip/kratos/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/sunzip/kratos/v2/transport/http/binding")
)
